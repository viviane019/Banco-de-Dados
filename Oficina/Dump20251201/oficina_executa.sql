...
CREATE TABLE `executa` (
  ...
  CONSTRAINT `executa_ibfk_1` FOREIGN KEY (`id_funcionario`) REFERENCES `funcionarios` (`id_funcionario`),
  CONSTRAINT `executa_ibfk_2` FOREIGN KEY (`id_servico`) REFERENCES `servicos` (`id_servico`)
...
INSERT INTO `executa` (`id_funcionario`, `id_servico`) VALUES (1,1),(1,2),(2,2),(3,3);
